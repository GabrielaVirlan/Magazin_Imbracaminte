...
namespace MagazinImbracaminte.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(MagazinImbracaminteContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,FirstName,LastName,PhoneNumber,EmailAdress,Passworld")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
