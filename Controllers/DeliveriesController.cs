...
namespace MagazinImbracaminte.Controllers
{
    public class DeliveriesController : Controller
    {
        ...
        public DeliveriesController(MagazinImbracaminteContext context)
        {
            _context = context;
        }
        ...
        {
            var magazinImbracaminteContext = _context.Deliveries.Include(d => d.Cart);
            return View(await magazinImbracaminteContext.ToListAsync());
        }
